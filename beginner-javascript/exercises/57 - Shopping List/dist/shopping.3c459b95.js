...
function handleSubmit(event) {
  ...
  var name = event.currentTarget.item.value; // access name input by name attribute (as is in a form)
...
window.onload = restoreFromLocalStorage(); // list for click on list, checks if it is then a button that was clicked
